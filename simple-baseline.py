...
def writePreds2File(preds, outputfile):
    ...
    pass
'''
Run file with python base_model.py --tweet_file datasets/EI-reg-En-anger-train.txt --lexicon datasets/NRC-AffectIntensity-Lexicon.txt  --outputfile train_preds.txt
'''
def main(args):
